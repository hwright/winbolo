...
gint dialogGameInfoUpdate(gpointer data) {
  ...
  if (dlgGameInfoTimeRemain != UNLIMITED_GAME_TIME) {
    ...
    sprintf(str, langGetText(STR_DLGGAMEINFO_TIMEREMAINING),
            dlgGameInfoTimeRemain);
...
GtkWidget *dialogGameInfoCreate(void) {
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogGameInfo), "lblNumPlayers",
                           lblNumPlayers, (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogGameInfo), "lblGameType",
                           lblGameType, (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogGameInfo), "lblHiddenMines",
                           lblHiddenMines, (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogGameInfo), "lblCompTanks",
                           lblCompTanks, (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogGameInfo), "lblGameTimeLimit",
                           lblGameTimeLimit,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  switch (*t) {
    case gameOpen:
      gtk_label_set_text(GTK_LABEL(lblGameType),
    ...
    default:
      ...
      gtk_label_set_text(GTK_LABEL(lblGameType),
                         langGetText(STR_DLGGAMEINFO_STRICT));
      break;
  }
  ...
  switch (temp) {
    ...
    default:
      /* aiYesAdvantage */
      gtk_label_set_text(GTK_LABEL(lblCompTanks),
                         langGetText(STR_DLGGAMEINFO_AIADV));
      break;
  }
  ...
  timerGameInfo =
      gtk_timeout_add(SECOND, dialogGameInfoUpdate, (gpointer) nullptr);
  gtk_signal_connect(GTK_OBJECT(dialogGameInfo), "delete_event",
                     GTK_SIGNAL_FUNC(dialogGameInfoClose), nullptr);
