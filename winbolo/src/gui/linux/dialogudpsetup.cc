...
static bool dialogUdpSetupDone(bool isJoin) {
  ...
  if (gtk_toggle_button_get_active(
          GTK_TOGGLE_BUTTON(idc_updsetupremembername)) == TRUE) {
...
static gboolean dialogUdpSetupTracker(GtkWidget *widget, GdkEventButton *event,
                                      gpointer user_data) {
  GtkWidget *tracker;
...
static gboolean dialogUdpSetupShow(GtkWidget *widget, GdkEventButton *event,
                                   gpointer user_data) {
  char pn[PLAYER_NAME_LEN];  /* Player name */
  ...
  gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(idc_updsetupremembername),
                              gameFrontGetRemeber());
  return FALSE;
}

static gboolean dialogUdpSetupReJoin(GtkWidget *widget, GdkEventButton *event,
                                     gpointer user_data) {
...
static gboolean dialogUdpSetupJoin(GtkWidget *widget, GdkEventButton *event,
                                   gpointer user_data) {
  if (dialogUdpSetupDone(TRUE) == TRUE) {
    dialogUdpClosing = TRUE;
    gtk_widget_set_sensitive(us, FALSE);
...
static gboolean dialogUdpSetupNew(GtkWidget *widget, GdkEventButton *event,
                                  gpointer user_data) {
  unsigned short udp; /* Udp ports */
  unsigned short myUdp;
...
static gboolean dialogUdpSetupCancel(GtkWidget *widget, GdkEventButton *event,
                                     gpointer user_data) {
  if (dialogUdpClosing == FALSE) {
    dialogUdpClosing = TRUE;
    gameFrontSetDlgState(us, openWelcome);
...
GtkWidget *dialogUdpSetupCreate(void) {
  ...
  gtk_object_set_data(GTK_OBJECT(dialogUdpSetup), "dialogUdpSetup",
                      dialogUdpSetup);
  ...
  label = gtk_label_new(
      ...
      "of a host\nmachine running Bolo, and the UDP port number of the Bolo "
      "process on that\nmachine");
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup), "idc_udpmachinename",
                           idc_udpmachinename,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup),
                           "idc_updsetuptxtthereport", idc_updsetuptxtthereport,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup), "idc_updsetuptxtourport",
                           idc_updsetuptxtourport,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(
      GTK_OBJECT(dialogUdpSetup), "idc_updsetuptxtplayername",
      idc_updsetuptxtplayername, (GtkDestroyNotify)gtk_widget_unref);
  ...
  idc_updsetupremembername =
      gtk_check_button_new_with_label("Remember player name");
  gtk_widget_ref(idc_updsetupremembername);
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup),
                           "idc_updsetupremembername", idc_updsetupremembername,
                           (GtkDestroyNotify)gtk_widget_unref);
  gtk_widget_show(idc_updsetupremembername);
  gtk_box_pack_start(GTK_BOX(hbox2), idc_updsetupremembername, FALSE, FALSE, 0);
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_updsetupremembername),
                               TRUE);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup), "idc_updsetuptracker",
                           idc_updsetuptracker,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup), "idc_updsetupcmdcancel",
                           idc_updsetupcmdcancel,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup), "idc_updsetupcmdrejoin",
                           idc_updsetupcmdrejoin,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup), "idc_updsetupcmdjoin",
                           idc_updsetupcmdjoin,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogUdpSetup), "idc_updsetupcmdnew",
                           idc_updsetupcmdnew,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  label10 = gtk_label_new(
      "Click \"Rejoin\" to rejoin a game and\nreclaim your old posessions");
  ...
  gtk_signal_connect(GTK_OBJECT(idc_updsetupcmdcancel), "clicked",
                     GTK_SIGNAL_FUNC(dialogUdpSetupCancel), nullptr);
  gtk_signal_connect(GTK_OBJECT(idc_updsetupcmdjoin), "clicked",
                     GTK_SIGNAL_FUNC(dialogUdpSetupJoin), nullptr);
  gtk_signal_connect(GTK_OBJECT(idc_updsetupcmdrejoin), "clicked",
                     GTK_SIGNAL_FUNC(dialogUdpSetupReJoin), nullptr);
  gtk_signal_connect(GTK_OBJECT(idc_updsetuptracker), "clicked",
                     GTK_SIGNAL_FUNC(dialogUdpSetupTracker), nullptr);
  gtk_signal_connect(GTK_OBJECT(idc_updsetupcmdnew), "clicked",
                     GTK_SIGNAL_FUNC(dialogUdpSetupNew), nullptr);
  gtk_signal_connect(GTK_OBJECT(dialogUdpSetup), "delete_event",
                     GTK_SIGNAL_FUNC(dialogUdpSetupCancel), nullptr);
  gtk_signal_connect(GTK_OBJECT(dialogUdpSetup), "show",
                     GTK_SIGNAL_FUNC(dialogUdpSetupShow), nullptr);
