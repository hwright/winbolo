...
static gboolean dialogAboutFunc(GtkWidget *widget, GdkEventButton *event,
                                gpointer user_data) {
...
GtkWidget *dialogAboutCreate(void) {
  ...
  pixmap_data = gdk_pixmap_colormap_create_from_xpm_d(
      nullptr, gtk_widget_get_colormap(dialogAbout), &pixmap_mask, nullptr,
      (gchar **)boloicon_xpm);
  ...
  gtk_signal_connect(GTK_OBJECT(dialogAbout), "delete_event",
                     GTK_SIGNAL_FUNC(dialogAboutFunc), nullptr);
