...
static gboolean dialogSetNameOK(GtkWidget *widget, GdkEventKey *event,
                                gpointer user_data) {
...
static gboolean dialogSetNameKey(GtkWidget *widget, GdkEventKey *event,
                                 gpointer user_data) {
...
static gboolean dialogSetNameClose(GtkWidget *widget, GdkEventButton *event,
                                   gpointer user_data) {
  gtk_grab_remove(dialogSetNameUs);
  gtk_widget_destroy(dialogSetNameUs);
  gtk_main_quit();
...
GtkWidget *dialogSetNameCreate(bool inGame) {
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogSetName), "idc_setnametxt",
                           idc_setnametxt, (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_signal_connect(GTK_OBJECT(dialogSetName), "delete_event",
                     GTK_SIGNAL_FUNC(dialogSetNameClose), nullptr);
  gtk_signal_connect(GTK_OBJECT(button1), "clicked",
                     GTK_SIGNAL_FUNC(dialogSetNameOK), nullptr);
  gtk_signal_connect(GTK_OBJECT(idc_setnametxt), "key-press-event",
                     GTK_SIGNAL_FUNC(dialogSetNameKey), nullptr);
