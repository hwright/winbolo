...
static gboolean dialogAllianceAccept(GtkWidget *widget, GdkEventButton *event,
                                     gpointer user_data) {
...
static gboolean dialogAllianceReject(GtkWidget *widget, GdkEventButton *event,
                                     gpointer user_data) {
  dialogAllianceIsShowing = FALSE;
  gtk_widget_hide(dialogAllianceUs);
...
GtkWidget *dialogAllianceCreate(void) {
  ...
  gtk_object_set_data(GTK_OBJECT(dialogAlliance), "dialogAlliance",
                      dialogAlliance);
  ...
  gtk_signal_connect(GTK_OBJECT(button1), "clicked",
                     GTK_SIGNAL_FUNC(dialogAllianceAccept), nullptr);
  gtk_signal_connect(GTK_OBJECT(button2), "clicked",
                     GTK_SIGNAL_FUNC(dialogAllianceReject), nullptr);
