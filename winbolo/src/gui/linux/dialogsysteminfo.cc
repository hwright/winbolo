...
GtkWidget *dialogSystemInfoCreate(void) {
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogSystemInfo), "lblSimModelling",
                           lblSimModelling, (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogSystemInfo), "lblCommProcessing",
                           lblCommProcessing,
                           (GtkDestroyNotify)gtk_widget_unref);
  ...
  gtk_object_set_data_full(GTK_OBJECT(dialogSystemInfo), "lblGraphics",
                           lblGraphics, (GtkDestroyNotify)gtk_widget_unref);
  ...
  sysInfoTimer =
      gtk_timeout_add(SECOND, dialogSysInfoUpdate, (gpointer) nullptr);
  gtk_signal_connect(GTK_OBJECT(dialogSystemInfo), "delete_event",
                     GTK_SIGNAL_FUNC(dialogSystemInfoClose), nullptr);
