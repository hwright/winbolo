 ...
 *********************************************************/
void drawRedrawAll(HINSTANCE appInst, HWND appWnd, buildSelect value,
                   RECT *rcWindow, bool showPillsStatus, bool showBasesStatus);
