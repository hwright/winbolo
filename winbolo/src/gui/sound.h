 ...
 *********************************************************/
void soundPlaySound(LPDIRECTSOUNDBUFFER *value, LPSTR lpzResourceName,
                    LPSTR lpzFileName);
 ...
 *  lpzFileName     - File name to load if buffer is lost
 *********************************************************/
IDirectSoundBuffer *soundLoadSound(IDirectSound *pDS, HMODULE hModule,
                                   LPCTSTR lpResourceName, LPCTSTR lpFileName);
 ...
 *  lpzFileName     - File name to load if buffer is lost
 *********************************************************/
bool soundReloadSoundBuffer(LPDIRECTSOUNDBUFFER *value, HMODULE hModule,
                            LPSTR resourceName, LPSTR lpzFileName);
