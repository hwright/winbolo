...
#define STATUS_BASE_2_X \
  (STATUS_BASE_1_X + STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X)
#define STATUS_BASE_2_Y STATUS_BASE_1_Y
#define STATUS_BASE_3_X \
  (STATUS_BASE_1_X + 2 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_3_Y STATUS_BASE_1_Y
#define STATUS_BASE_4_X \
  (STATUS_BASE_1_X + 3 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_4_Y STATUS_BASE_1_Y
#define STATUS_BASE_5_X \
  (STATUS_BASE_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_5_Y STATUS_BASE_1_Y
#define STATUS_BASE_6_X \
  (STATUS_BASE_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_6_Y STATUS_BASE_1_Y
#define STATUS_BASE_7_X STATUS_BASE_1_X
#define STATUS_BASE_7_Y \
  (STATUS_BASE_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_BASE_8_X \
  (STATUS_BASE_1_X + (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_8_Y \
  (STATUS_BASE_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_BASE_9_X \
  (STATUS_BASE_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_9_Y \
  (STATUS_BASE_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_BASE_10_X \
  (STATUS_BASE_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_10_Y \
  (STATUS_BASE_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_BASE_11_X STATUS_BASE_1_X
#define STATUS_BASE_11_Y \
  (STATUS_BASE_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_BASE_12_X \
  (STATUS_BASE_1_X + (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_12_Y \
  (STATUS_BASE_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_BASE_13_X \
  (STATUS_BASE_1_X + 2 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_13_Y \
  (STATUS_BASE_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_BASE_14_X \
  (STATUS_BASE_1_X + 3 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_14_Y \
  (STATUS_BASE_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_BASE_15_X \
  (STATUS_BASE_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_15_Y \
  (STATUS_BASE_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_BASE_16_X \
  (STATUS_BASE_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_BASE_16_Y \
  (STATUS_BASE_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
/* The middle square for drawing the icon */
#define STATUS_BASES_MIDDLE_ICON_X 37
#define STATUS_BASES_MIDDLE_ICON_Y \
  ((STATUS_BASE_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y) - 2)

/* Pillbox Status Position */
#define STATUS_PILLBOX_1_X 4
#define STATUS_PILLBOX_1_Y 4
#define STATUS_PILLBOX_2_X \
  (STATUS_PILLBOX_1_X + STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X)
#define STATUS_PILLBOX_2_Y STATUS_PILLBOX_1_Y
#define STATUS_PILLBOX_3_X \
  (STATUS_PILLBOX_1_X + 2 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_3_Y STATUS_PILLBOX_1_Y
#define STATUS_PILLBOX_4_X \
  (STATUS_PILLBOX_1_X + 3 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_4_Y STATUS_PILLBOX_1_Y
#define STATUS_PILLBOX_5_X \
  (STATUS_PILLBOX_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_5_Y STATUS_PILLBOX_1_Y
#define STATUS_PILLBOX_6_X \
  (STATUS_PILLBOX_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_6_Y STATUS_PILLBOX_1_Y
#define STATUS_PILLBOX_7_X STATUS_PILLBOX_1_X
#define STATUS_PILLBOX_7_Y \
  (STATUS_PILLBOX_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_PILLBOX_8_X \
  (STATUS_PILLBOX_1_X + (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_8_Y \
  (STATUS_PILLBOX_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_PILLBOX_9_X \
  (STATUS_PILLBOX_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_9_Y \
  (STATUS_PILLBOX_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_PILLBOX_10_X \
  (STATUS_PILLBOX_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_10_Y \
  (STATUS_PILLBOX_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_PILLBOX_11_X STATUS_PILLBOX_1_X
#define STATUS_PILLBOX_11_Y \
  (STATUS_PILLBOX_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_PILLBOX_12_X \
  (STATUS_PILLBOX_1_X + (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_12_Y \
  (STATUS_PILLBOX_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_PILLBOX_13_X \
  (STATUS_PILLBOX_1_X + 2 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_13_Y \
  (STATUS_PILLBOX_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_PILLBOX_14_X \
  (STATUS_PILLBOX_1_X + 3 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_14_Y \
  (STATUS_PILLBOX_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_PILLBOX_15_X \
  (STATUS_PILLBOX_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_15_Y \
  (STATUS_PILLBOX_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_PILLBOX_16_X \
  (STATUS_PILLBOX_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_PILLBOX_16_Y \
  (STATUS_PILLBOX_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
/* The middle square for drawing the icon */
#define STATUS_PILLS_MIDDLE_ICON_X 37
#define STATUS_PILLS_MIDDLE_ICON_Y \
  ((STATUS_BASE_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y) - 2)

/* Tank Status positions */
#define STATUS_TANKS_1_X 4
#define STATUS_TANKS_1_Y 4
#define STATUS_TANKS_2_X \
  (STATUS_TANKS_1_X + STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X)
#define STATUS_TANKS_2_Y STATUS_TANKS_1_Y
#define STATUS_TANKS_3_X \
  (STATUS_TANKS_1_X + 2 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_3_Y STATUS_TANKS_1_Y
#define STATUS_TANKS_4_X \
  (STATUS_TANKS_1_X + 3 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_4_Y STATUS_TANKS_1_Y
#define STATUS_TANKS_5_X \
  (STATUS_TANKS_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_5_Y STATUS_TANKS_1_Y
#define STATUS_TANKS_6_X \
  (STATUS_TANKS_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_6_Y STATUS_TANKS_1_Y
#define STATUS_TANKS_7_X STATUS_TANKS_1_X
#define STATUS_TANKS_7_Y \
  (STATUS_TANKS_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_TANKS_8_X \
  (STATUS_TANKS_1_X + (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_8_Y \
  (STATUS_TANKS_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_TANKS_9_X \
  (STATUS_TANKS_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_9_Y \
  (STATUS_TANKS_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_TANKS_10_X \
  (STATUS_TANKS_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_10_Y \
  (STATUS_TANKS_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y)
#define STATUS_TANKS_11_X STATUS_TANKS_1_X
#define STATUS_TANKS_11_Y \
  (STATUS_TANKS_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_TANKS_12_X \
  (STATUS_TANKS_1_X + (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_12_Y \
  (STATUS_TANKS_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_TANKS_13_X \
  (STATUS_TANKS_1_X + 2 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_13_Y \
  (STATUS_TANKS_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_TANKS_14_X \
  (STATUS_TANKS_1_X + 3 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_14_Y \
  (STATUS_TANKS_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_TANKS_15_X \
  (STATUS_TANKS_1_X + 4 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_15_Y \
  (STATUS_TANKS_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
#define STATUS_TANKS_16_X \
  (STATUS_TANKS_1_X + 5 * (STATUS_ITEM_GAP_X + STATUS_ITEM_SIZE_X))
#define STATUS_TANKS_16_Y \
  (STATUS_TANKS_1_Y + 2 * (STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y))
/* The middle square for drawing the icon */
#define STATUS_TANKS_MIDDLE_ICON_X 37
#define STATUS_TANKS_MIDDLE_ICON_Y \
  ((STATUS_TANKS_1_Y + STATUS_ITEM_GAP_Y + STATUS_ITEM_SIZE_Y) - 2)
...
#define BAR_TANK_MULTIPLY 2 /* Times item amounts by 2 for 80 pixel high bars \
                             */
#define STATUS_TANK_BARS_TOP \
  155  // was 105 but it cut off part of the tombstone
#define STATUS_TANK_BARS_HEIGHT \
  85  // was 135 but it cut off part of the tombstone
#define STATUS_TANK_BARS_WIDTH 3
#define STATUS_TANK_BARS_GAP 9
#define STATUS_TANK_BARS_TOTALWIDTH \
  ((3 * STATUS_TANK_BARS_GAP) + (4 * STATUS_TANK_BARS_WIDTH))
#define STATUS_TANK_SHELLS 446
#define STATUS_TANK_MINES \
  STATUS_TANK_SHELLS + ((STATUS_TANK_BARS_WIDTH + STATUS_TANK_BARS_GAP))
#define STATUS_TANK_ARMOUR \
  STATUS_TANK_SHELLS + (2 * (STATUS_TANK_BARS_WIDTH + STATUS_TANK_BARS_GAP))
#define STATUS_TANK_TREES \
  STATUS_TANK_SHELLS + (3 * (STATUS_TANK_BARS_WIDTH + STATUS_TANK_BARS_GAP))

#define BAR_BASE_MULTIPLY \
  (2.0 / 3.0) /* Times item amounts by 2/3 for 54 pixel wide bars */
...
#define STATUS_BASE_BARS_TOTALHEIGHT \
  ((3 * STATUS_BASE_BARS_HEIGHT) + (2 * STATUS_BASE_BARS_GAP))
