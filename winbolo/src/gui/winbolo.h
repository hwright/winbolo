 ...
 *********************************************************/
LRESULT CALLBACK ExWindowProc(HWND hWnd, UINT msg, WPARAM wParam,
                              LPARAM lParam);
 ...
 *  lParam - ????
 *********************************************************/
LRESULT CALLBACK windowAboutBoxProc(HWND hwnd, unsigned uMsg, WPARAM wParam,
                                    LPARAM lParam);
 ...
 *
 *********************************************************/
void CALLBACK windowGameTimer(UINT uID, UINT uMsg, DWORD dwUser, DWORD dw1,
                              DWORD dw2);
 ...
 *
 *********************************************************/
void CALLBACK windowFrameRateTimer(UINT uID, UINT uMsg, DWORD dwUser, DWORD dw1,
                                   DWORD dw2);
