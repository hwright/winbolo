 ...
 *********************************************************/
BOOL CALLBACK dialogGameSetupCallback(HWND hWnd, unsigned uMsg, WPARAM wParam,
                                      LPARAM lParam);
 ...
 *  lParam - More Message parameters
 *********************************************************/
BOOL CALLBACK dialogGameFinderOpeningProc(HWND hDlg, UINT uMsg, WPARAM wParam,
                                          LPARAM lParam);
