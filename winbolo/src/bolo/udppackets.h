...
struct udpPacketsObj {
  BYTE outSequenceNumber; /* The next packet sequence number to get for sending
                             out */
  BYTE outBuff[MAX_UDP_SEQUENCE]
              [SIZE_OF_PACKET];  /* Copy of the packets for retransmission */
  ...
  BYTE inBuff[MAX_UDP_SEQUENCE]
             [SIZE_OF_PACKET]; /* Copy of the incoming packets for processing on
                                  missing packets */
 ...
 *********************************************************/
void udpPacketsSetInBuff(udpPackets *value, BYTE sequenceNumber, BYTE *buff,
                         int length);
 ...
 * length         - Lenght of the buffer
 ********************************************************/
void udpPacketsSetOutBuff(udpPackets *value, BYTE sequenceNumber, BYTE *buff,
                          int length);
