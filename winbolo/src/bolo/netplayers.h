...
typedef struct {          /* Obj */
  ...
  bool inGame[MAX_TANKS]; /* Have they entered the game or are they still
                             joining? */
  struct sockaddr_in addr[MAX_TANKS]; /* Last packet from address */
  bool locked[MAX_TANKS];             /* Are they locked */
  bool passed[MAX_TANKS]; /* Have they entered the password (if required by the
                             server) */
  bool passedrsa[MAX_TANKS];   /* Have they passed the rsa check key check? Min
                                  dec 16th 2008*/
 ...
 *********************************************************/
void netPlayersSetPlayer(netPlayers *value, BYTE playerNum,
 ...
 *********************************************************/
BYTE netPlayersGetPlayerNumber(netPlayers *value, unsigned long addr,
                               unsigned short port);
 ...
 *  addr      - Address structure of client
 *********************************************************/
void netPlayersSetAddr(netPlayers *value, BYTE playerNum,
                       struct sockaddr_in *addr);
 ...
 *  port      - Port
 *********************************************************/
void netPlayersGetPlayerDataReq(netPlayers *value, BYTE playerNum,
 ...
 *********************************************************/
bool netPlayersCheck(netPlayers *value, BYTE playerNum, time_t t,
                     time_t ourTime);
